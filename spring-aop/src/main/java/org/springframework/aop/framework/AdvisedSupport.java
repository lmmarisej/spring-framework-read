...
public class AdvisedSupport extends ProxyConfig implements Advised {
	 ...
	 */
	TargetSource targetSource = EMPTY_TARGET_SOURCE;		// 可以将HotSwappableTargetSource配置进来。
	/**
	 ...
	 * for the given target class will be used. The kind of proxy needed will be determined on
	...
	public List<Object> getInterceptorsAndDynamicInterceptionAdvice(Method method, @Nullable Class<?> targetClass) {
		MethodCacheKey cacheKey = new MethodCacheKey(method);		// 为了性能考虑，做了缓存
