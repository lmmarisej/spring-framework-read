...
public class PropertyEditorRegistrySupport implements PropertyEditorRegistry {
	 ...
	 * general inappropriate for data binding purposes. Of course, you may register them
	...
	/**
	 * 注册 CustomEditor
	 * @param requiredType   the type of the property. This may be {@code null} if a property is
	 *                       given but should be specified in any case, in particular in case of a
	 *                       Collection - making clear whether the editor is supposed to apply to
	 *                       the entire Collection itself or to each of its entries. So as a general
	 *                       rule:
	 ...
	 * BeanWrapperImpl overrides this with the standard {@code getPropertyType} method as defined by
	 ...
	 *                       non-null, only editors registered for a path below this nested property
	...
	private static final class CustomEditorHolder {
		...
		private PropertyEditor getPropertyEditor(@Nullable Class<?> requiredType) {
			...
			// for elements.)
			// 对比 参数的requiredType 和 类自己的 requiredType 是否相同
